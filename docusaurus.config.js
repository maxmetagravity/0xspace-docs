...
const config = {
  ...
  organizationName: '0xSPACE', // Usually your GitHub org/user name.
  projectName: '0xSPACE', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/maxmetagravity/0xspace-docs/blob/master/',
        },
        blog: {
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} 0xSPACE, Inc.`,
      },
      prism: {
